...
async function getTenantPublic(req: Request, res: Response) {
  ...
  res.json({
    publishable_key: tenant.publishableKey,
    tenant_public_key: tenant.tenantPublicKey,
    embed_js: 'https://cdn.flaek.dev/embed.min.js',
  })
}
