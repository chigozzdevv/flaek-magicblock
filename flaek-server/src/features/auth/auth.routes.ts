...
router.post(
  '/verify-totp',
  schemaValidator(verifyTotpSchema),
  asyncHandler(authController.verifyTotp),
)
...
router.post(
  '/totp/verify',
  jwtAuth,
  schemaValidator(totpVerifyJwtSchema),
  asyncHandler(authController.totpVerifyJwt),
)
router.post(
  '/totp/disable',
  jwtAuth,
  schemaValidator(totpDisableSchema),
  asyncHandler(authController.totpDisable),
)
